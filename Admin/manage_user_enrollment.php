<?php 
 			...
 			<div class="card m-1  border border-light " style="background-color:#5189B8;">
 				<div class="card-header bg-light text-dark">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                      <div class="container-fluid">
                        <a class="navbar-brand" href="#">Manage Enrolments</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                              <a class="nav-link  active bg-warning rounded-pill text-light" aria-current="page" href="#">Enrol Users</a>
                            </li>
                             <li class="nav-item">
            ...
            <div class="card-body  text-dark m-3 ">
             ...
             <div class="row m-3">
                ...
                <table  id="example" class="display text-center" style="width:100%">
                    ...
                    <td>
                       <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo$rec['user_id']  ?>" onclick="<?php $user_id = $rec['user_id']  ?>">
                          Enrol
                        </button>
                        ...
                        ?>
                        <!-- Modal -->
                        <div class="modal fade" id="staticBackdrop<?php echo$rec['user_id']  ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body p-5">
                                <h4><img src="<?php echo $rec['image'] ?>" style="width: 90px; height:70px; border-radius: 50%;">  <?php echo ucwords($rec['first_name']." ".$rec['last_name']) ?></h4>
                                <hr>
                                <br>
                               <form class="row g-3 needs-validation " novalidate enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        if ($fetch_batch_result->num_rows) 
                                        {
                                          ...
                                          <select class="form-select" id="course_batch_id<?php echo$user_id  ?>">
                                            <?php
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                      ...
                                      $role_query = "SELECT * FROM user_role , roles where roles.role_id = user_role.role_id AND user_role.status_id = 1 AND USER_ROLE.role_id <> '1' AND user_role.user_id = '".$user_id."' ORDER BY user_role.role_id ASC";
 ...
 <!-- #################### -->
      ...
      <script type="text/javascript">
            ...
            {
                var batch_course_id = document.getElementById('course_batch_id'+userid).value;
