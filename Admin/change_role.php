 ...
 <div class="container-fluid">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active bg-warning rounded-pill text-light" href="change_role.php" aria-current="page">Change Roles Status</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="change_role_active.php" aria-current="page">Active Role</a>
                        </li>
    ...
    <div class="row m-3">
        ...
        ?>         
         ...
         <td>
             <?php 
                ...
                $select_in_active_query = "SELECT * FROM user_role ur , roles r WHERE r.role_id = ur.role_id AND ur.`status_id` IN (1,2) AND ur.user_id='".$rec['user_id']."'";
        ...
        <td >
                        ...
                        if ($mycheck['status_id'] == 1) 
                        {
                            ?>
                            <button class="btn btn-primary" onclick="user_role_status(<?php echo $rec['user_id'] ?>)">InActive</button>
                            <?php
                        }
                        else
                        {
                           ?>
                            <button class="btn btn-primary" onclick="user_role_status(<?php echo $rec['user_id'] ?>)">Active</button>
                            <?php 
                        }
 ...
 <!-- #################### -->
      ...
      <script type="text/javascript">
           ...
           //#####  ROLE ASSIGN FUNCTION ################
            ...
            function user_role_status(userid)

            {
                var set_role_status = document.getElementsByTagName('user_role_status');
                ...
                obj.send("action=role_status&user_id="+userid+"&role_id="+role_id);
            }
