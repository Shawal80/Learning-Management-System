 ...
 <div class="container-fluid">
    ...
    <div class="row m-3">
    	<div class="col-sm-3">
 		...
 		<div class="col-sm-6">
 			<div class="card">
 				<div class="card-header bg-light text-secondary text-center"><b style="font-size:15px;">Courses</b></div>
 				<div class="card-body">
 						<?php 
						 ...
						 if ($check_role_result->num_rows) 
						 {
						 	...
						 	if ($batch_course_result->num_rows) 
						 	{
						 		...
						 		?>
						 		<div class="m-3">
						 		<a href="#"style="font-size:17px"><?php echo strtoupper($record['batch_title']." ".$record['course_title']) ?></a>

						 		<p style="font-size:14px"> <?php echo $record['course_description']; ?>	
						 		</p>
