 ...
 <div class="container-fluid">
    ...
    <div class="row m-3">
    	<div class="col-sm-3">
 		...
 		<div class="col-sm-9">
 			<div class="card">
 				<div class="card-header bg-light text-secondary"><b style="font-size: 23px;">Courses</b></div>
 				<div class="card-body">
 						<?php 
						 ...
						 if ($check_role_result->num_rows) 
						 {
						 	...
						 	if ($batch_course_result->num_rows) 
						 	{
						 		...
						 		?>
						 		<div class="m-3">
						 		<a href="show_course_detail.php?batch_course_id=<?php echo $course['batch_course_id'] ?>"style="font-size:24px"><?php echo $record['batch_title']." ".$record['course_title'] ?></a>
						 		<p style="font-size:18px"> <?php echo $record['course_description']; ?>	
						 		</p>
