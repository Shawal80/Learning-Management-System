 ...
 <div class="container-fluid">
    ...
    <div class="row m-3">
    	<div class="col-sm-3">
 		...
 		<div class="col-sm-6">
 			<div class="card">
 				<div class="card-header bg-light text-secondary text-center"><b style="font-size: 15px;">Manage Course Material</b></div>
 				<div class="card-body">
 					<h5 class="text-center">Select Batch To View Topics & Material</h5>
 					<hr>
 						<?php 
						 ...
						 if ($check_role_result->num_rows) 
						 {
						 	...
						 	if ($batch_course_result->num_rows) 
						 	{
						 		...
						 		?>
						 		<div class="m-3">
						 		<a href="show_course_topic_material.php?batch_course_id=<?php echo $course['batch_course_id'] ?>&batch_title=<?php echo $record['batch_title']." ".$record['course_title'] ?>"style="font-size:17px"><?php echo strtoupper($record['batch_title']." ".$record['course_title']) ?></a>
						 		<hr>
